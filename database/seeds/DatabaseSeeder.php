...
class DatabaseSeeder extends Seeder
{
    ...
    public function run() {
        ...
        DB::table('users')->insert(['name' => 'Laden45','email' => 'laden45@gmail.com', 'password' => '$2y$10$WGd/zkQkvv2.O7O936GQn.buiJE33cSNAz4TtBWViu6upN6iOEdL6']);
      ...
      #  DB::table('sensors')->insert(['name' => 'SEN-4','valor' => 45,'ambiente_id' => 1,'prototype_id' => 1]);
